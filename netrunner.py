...
class NetLayer:
    ...
    def use_active_functions(self):
        if self.activation == 'input':
            ...
            raise NetError(self.original_values, "Invalid activation function.")
    ...
    def get_active_derivatives(self):
        if self.activation == 'input':
            ...
            raise NetError(self.active_values, "Invalid activation function.")
    ...
    def __init__(self, net_layers):
        ...
        for net_layer in self.net_layers:
            if net_layer.activation == 'input':
                has_input = True
        if not has_input:
            raise NetError(self.net_layers, "Input layer not present.")
